...
import { resource as question, self as questionUri } from './question/cf6-question';
...
import { resource as choices, self as choicesUri } from './question/cf6/choice-feed';
...
import { resource as infoStep, self as infoStepUri } from './organisation/a65/step/b36-info';
import { resource as info, self as infoUri } from './organisation/a65/information/101';
...
export const fakeResponseFactory = <T extends LinkedRepresentation>(resource: T, rel: RelationshipType): Partial<AxiosResponse<T>> | never => {
    ...
    function factory(uri: string): T {
        switch (uri) {
            ...
            case workflowStepUri:
                return workflowStep as unknown as T;
            case headingUri:
                return heading as unknown as T;
            case editFormUri:
            ...
            case infoStepUri:
                return infoStep as unknown as T;
            case infoUri:
